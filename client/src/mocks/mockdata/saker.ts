...
export const sakerMock = [
  ...
  },
  {
    ...
    datoOpprettet: '2024-01-04T14:06:18.103+00:00',
    datoOppdatert: '2024-01-04T14:06:22.236+00:00',
    status: SoknadStatus.VEDTAKSRESULTAT_HENLAGT_SØKNAD_TRUKKET,
    fnrBruker: '13820599335',
    navnBruker: 'Rulla Tor',
    søknadsdata: undefined,
    valgteÅrsaker: undefined,
  },
   {
    ...
    datoOpprettet: formatISO(subDays(new Date(), 12)),
    datoOppdatert: formatISO(subDays(new Date(), 12)),
    status: SoknadStatus.VEDTAKSRESULTAT_HENLAGT_FEIL_HJELPEMIDDEL,
    fnrBruker: '12345678910',
    navnBruker: 'Giovanni Varmevotti',
    søknadsdata: undefined,
    valgteÅrsaker: undefined,
  },
  {
    ...
    datoOpprettet: formatISO(subDays(new Date(), 3)),
    datoOppdatert: formatISO(subDays(new Date(), 3)),
    status: SoknadStatus.VEDTAKSRESULTAT_HENLAGT_FLERE_SØKNADER_SAMME_BEHOV,
    fnrBruker: '12345678910',
    navnBruker: 'Rulle Stolbakken',
    søknadsdata: undefined,
    valgteÅrsaker: undefined,
  ...
  },
  {
    ...
    datoOpprettet: '2021-02-07T14:06:59.269+00:00',
    datoOppdatert: '2021-03-08T14:06:59.269+00:00',
    status: SoknadStatus.VEDTAKSRESULTAT_HENLAGT_ANNET,
    fnrBruker: '12345678910',
    navnBruker: 'Helen Adams Keller',
    søknadsdata: undefined,
    valgteÅrsaker: undefined,
