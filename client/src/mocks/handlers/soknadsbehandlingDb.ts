        ...
        søknadsdata: {
          ...
          hjelpemidler: [
            ...
            },
            {
              ...
              utlevertInfo: {},
              bruksarena: ['EGET_HJEM_IKKE_AVLASTNING', 'OMSORGSBOLIG_BOFELLESKAP_SERVICEBOLIG', 'INSTITUSJON'],
              bytter: [],
            },
          ],
          ...
          hjelpemidler: [
            {
              ...
              diverseInfo: {},
              bytter: [],
              bruksarena: ['GRUNN_ELLER_VIDEREGÅENDESKOLE'],
            },
            {
              antall: 1,
              arsakForAntall: null,
    ...
    return res(
      ctx.json({
        ...
        søknadsdata: {
          ...
          hjelpemidler: [
            ...
            },
            {
              ...
              produkt: {
                ...
                artid: 'HMDB-115542',
                prodid: 'HMDB-64509',
                artname: 'Classic Soft',
                prodname: 'Classic',
                pshortdesc:
                  'Albuekrykke med regulerbar høyde fra 76 - 96 cm. Passer brukerhøyde fra 152 - 192 cm. Finnes i to utgaver. Leveres enkeltvis. Maks. brukervekt: 140 kg. Ispigger kan fås som tilbehør.',
                apostid: 'HMDB-1348',
                postrank: '1',
                apostnr: '17',
                aposttitle: '17. Krykker til voksne enkel',
                newsid: 'f1ddd971-17f1-4241-8593-edaf377f66f0',
                isocode: '12030601',
                isotitle: 'Albuekrykker',
                kategori: 'Ganghjelpemidler',
                techdataAsText:
                  'Beregnet på barn NEI, Høyde min 76cm, Høyde maks 96cm, Brukervekt maks 140kg, Totalvekt 0.6kg',
                haystack:
                  '267912 classic soft 17. krykker til voksne enkel albuekrykker beregnet på barn nei, høyde min 76cm, høyde maks 96cm, brukervekt maks 140kg, totalvekt 0.6kg',
                cleanposttitle: '7. Krykker til voksne enkel',
                cleanTechdataAsText: 'Høyde min 76cm, Høyde maks 96cm',
                erIBestillingsordning: true,
                image: 'https://finnhjelpemiddel.intern.dev.nav.no/imageproxy/400d/orig/64509.jpg',
                filters: {
                  totalVektKG: 0.6,
                  beregnetBarn: 'NEI',
                  brukervektMaksKG: 140,
                },
              },
              tilbehorListe: [
                {
                  ...
                  antall: 1,
                  brukAvForslagsmotoren: {
                    lagtTilFraForslagsmotoren: false,
                    oppslagAvNavn: true,
                  },
                ...
                },
                {
                  ...
                  begrunnelse:
                    'Bruker trenger krone til de dagene det virkelig er glatt, fordi da er det ikke nok med pigg. Bruker skal reise til Svalbard og må derfor være godt utrustet med nødvendig utstyr. Bruker mener også at krone fungerer bedre som beskyttelse mot isbjørn enn pigg',
                },
              ],
              begrunnelsen: '',
              kanIkkeTilsvarande: false,
              ganghjelpemiddelInfo: {},
              utlevertInfo: {},
              bruksarena: ['EGET_HJEM'],
              bytter: [],
            },
          ],
          hjelpemiddelTotalAntall: 7,
          oppfolgingsansvarlig: null,
          levering: {
            kontaktPerson: { navn: null, telefon: null, kontaktpersonType: 'HJELPEMIDDELBRUKER' },
            leveringsmaate: 'FOLKEREGISTRERT_ADRESSE',
          ...
          hast: {
            hasteårsaker: ['UTVIKLING_AV_TRYKKSÅR', 'TERMINALPLEIE'],
            hastBegrunnelse: 'en fritekstbegrunnelse for hast',
          },
        },
      })
    )
